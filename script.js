...
(function () {
  ...
  function answer(raw) {
    ...
    if (/(available|homes|apartment|units|شقق|متوفر|مشاريع|منازل)/.test(t))
      return {
        text: ar
          ? "حالياً: مشروع الشاذروان ١٧١٩ — شقق واسعة بواجهات حجرية فاخرة في موقع مميّز بعمّان، ومشاريع أخرى قادمة قريباً."
    ...
    if (/(who|about|company|من|عن الشركة|الشاذروان)/.test(t))
      return {
        text: ar
          ? "شركة الشاذروان للإسكان — نبني منذ عام ٢٠١٠ منازل تجمع الجودة والراحة وقيمة تدوم."
...
const I18N_AR = {
  ...
  ".stage-title": ["أعمدة وقواعد وأساس.", "بلاطات وجدران ثم ضوء.", "شاهد ماذا يوجد داخل كل بيت."],
  ".process-lead": "من أول معاينة للأرض حتى تسليم المفتاح — كل منزل من الشاذروان يمر بالنهج ذاته دون تنازل.",
  ".process-step h3": ["الأرض", "الهيكل", "التشطيب", "التسليم"],
  ".process-step p": [
    "نختار أرقى المناطق وأكثرها حيوية، وندرس كل قطعة أرض قبل وضع أول حجر.",
    "خرسانة مسلّحة وحجر طبيعي، بهندسة وإشراف يضمنان متانة تدوم لأجيال.",
  ...
  ".vm-label": ["رؤيتنا", "رسالتنا"],
  ".vm-text": [
    "أن نكون في مقدمة شركات التطوير العقاري في الأردن، نُعرَف بجودتنا وابتكارنا وبقيمةٍ تدوم.",
    "أن نبني منازل عصرية تجمع الراحة والثقة، وتناسب كل عائلة.",
  ],
  ".residence-title": "مشروع <em>١٧١٩</em>",
  ".feature h3": ["مساحات رحبة", "واجهات فاخرة", "شرفات خاصة", "موقع مميز"],
  ".feature p": [
    "شقق واسعة مصمّمة لحياة العائلة اليوم، بغرف مضيئة وتوزيع مفتوح.",
  ...
  ".listings-lead": "شقق جاهزة للسكن في مشروع ١٧١٩ — احجز شقتك قبل أن تُحجَز.",
  ...
  ".lifestyle-lead": "مساحات داخلية تمنحك متّسعاً للراحة — دافئة، هادئة، ومصمّمة لتفاصيل يومك.",
  ".life-item figcaption": ["غرفة المعيشة", "انحناءات ناعمة", "الساعة الذهبية", "المدفأة", "هدوء أنيق", "تفاصيل هادئة"],
  ".gallery-lead": "اسحب لتستكشف مشروعنا بتقنية ثلاثية الأبعاد — من أول حجر حتى تسليم المفتاح.",
  ...
  ".footer-news-sub": "كن أول من يصله خبر مشاريعنا الجديدة ومواعيد المعاينات الخاصة.",
